...
xgb_params = {       
        ...
        'n_estimators': 400,  }        # subsampling ratio 


# COMPUTE CV SCORE WITH 5 GROUP K FOLD
for i, (train_index, test_index) in enumerate(gkf.split(X=df_tr_train, groups=df_tr_train.index)):
    print('#'*25)
    print('### Fold',i+1)
    print('#'*25)
