...
learning_rates = [0.00001,0.00005,0.0001,0.0005,0.001,0.005,0.01, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5]
THR=[]
acc=[]
bF1=[]
models = {}
for lr in learning_rates:
    xgb_params = {       
        'learning_rate': lr,              # can vary
        'max_depth': 4,                   # can vary 
        'n_estimators': 1000,             # can vary 
        'subsample':0.8,
...
plt.plot(learning_rates, acc, '-o', color='blue')
plt.xlabel('Learning Rate', size=14)
plt.ylabel('Accuracy', size=14)
plt.title('Testing Accuracy vs. Learning Rate', size=18)
plt.grid(True)
plt.show()

# Plot threshold vs. learning rate
plt.figure(figsize=(10, 5))
plt.plot(learning_rates, THR, '-o', color='orange')
plt.xlabel('Learning Rate', size=14)
plt.ylabel('Threshold', size=14)
plt.title('Training Threshold vs. Learning Rate', size=18)
plt.grid(True)
plt.show()

# Plot best F1 score vs. learning rate
plt.figure(figsize=(10, 5))
plt.plot(learning_rates, bF1, '-o', color='green')
plt.xlabel('Learning Rate', size=14)
plt.ylabel('Best F1 Score', size=14)
plt.title('Training Best F1 Score vs. Learning Rate', size=18)
plt.grid(True)
plt.show()
...
plt.plot(learning_rates, acc, '-o', label='Accuracy')
plt.plot(learning_rates, bF1, '-o', label='Balanced F1 Score')
plt.plot(learning_rates, THR, '-o', label='Best Threshold')
