...
plt.plot(max_depth, acc, '-o', color='blue')
plt.xlabel('max_depth', size=14)
plt.ylabel('Accuracy', size=14)
plt.title('Testing Accuracy vs. max_depth', size=18)
plt.grid(True)
plt.show()

# Plot threshold vs. learning rate
plt.figure(figsize=(10, 5))
plt.plot(max_depth, THR, '-o', color='orange')
plt.xlabel('max_depth', size=14)
plt.ylabel('Threshold', size=14)
plt.title('Training Threshold vs. max_depth', size=18)
plt.grid(True)
plt.show()

# Plot best F1 score vs. learning rate
plt.figure(figsize=(10, 5))
plt.plot(max_depth, bF1, '-o', color='green')
plt.xlabel('max_depth', size=14)
plt.ylabel('Best F1 Score', size=14)
plt.title('Training Best F1 Score vs. max_depth', size=18)
plt.grid(True)
plt.show()
...
plt.plot(max_depth, acc, '-o', label='Accuracy')
plt.plot(max_depth, bF1, '-o', label='Balanced F1 Score')
plt.plot(max_depth, THR, '-o', label='Best Threshold')
plt.xlabel('Learning Rate')
plt.ylabel('Score')
plt.title('Max_depth vs. Performance Metrics')
plt.grid()
plt.legend()
plt.show()
